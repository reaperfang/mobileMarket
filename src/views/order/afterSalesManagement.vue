            ...
            <el-table
                ...
                <el-table-column label="操作" width="220">
                    <template slot-scope="scope">
                        ...
                        <span v-permission="['订单', '售后管理', '默认页', '确认收货']" class="blue pointer" @click="confirmReceived(scope.row)" v-if="scope.row.orderAfterSaleStatus == 2 && !scope.row.isSellerReceived">确认收货</span>
