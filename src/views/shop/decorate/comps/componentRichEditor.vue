...
<template>
    <div>
      <div class="rich_wrapper" v-if="currentComponentData.data.richValue" v-html="currentComponentData.data.richValue" :style="{'padding': (currentComponentData.data.remainPageMargin ? '10px' : '0')}"></div>
